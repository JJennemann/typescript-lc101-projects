...
// console.log(`It will take ${spaceShuttle.getDaysToLocation(kilometersToMars)} ${spaceShuttle.name} days to get to Mars.`);
// console.log(`It will take ${spaceShuttle.getDaysToLocation(kilometersToTheMoon)} ${spaceShuttle.name} days to get to Mars.`);
